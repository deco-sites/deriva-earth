...
export default function ContactFormHybrid({
  ...
  return (
    <div class="relative min-h-screen">
      ...
      <img 
        src="https://decoims.com/derivative/e3cc05d0-af74-4a93-b85e-ec9dc6378053/Jubarte-I-(1).jpg"
        alt="Background"
        ...
        <div class="container mx-auto px-4 py-6">
          ...
          <div class="hidden md:flex md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
              ...
              >
                <img 
                  src="https://decoims.com/derivative/c0c8a74e-844d-43dc-80d6-d9eafb95be2f/insta.svg"
                  alt="Instagram"
                  class="w-6 h-6"
                />
              </a>
